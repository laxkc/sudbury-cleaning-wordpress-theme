...
$hero_image = get_theme_mod('nova_hero_image', '');
?>
<section class="hero">
  <div class="container">
    <div class="hero__grid">
      <div class="hero__copy">
        <span class="hero__eyebrow">
          <span class="icon-label__icon"><?php nova_print_icon('sparkle', 12); ?></span>
          <span><?php echo esc_html(nova_setting('hero_eyebrow')); ?></span>
        </span>
        <h1 class="hero__title"><?php echo esc_html(nova_setting('hero_title')); ?></h1>
        <p class="hero__lead"><?php echo esc_html(nova_setting('hero_lead')); ?></p>
        ...
        <div class="hero__actions">
          ...
          <a class="btn btn--outline btn--lg" href="<?php echo esc_attr(nova_phone_link()); ?>">
      ...
      <div class="hero__media">
        ...
        <div class="hero__badge">
          <span class="icon-label__icon"><?php nova_print_icon('star', 16); ?></span>
