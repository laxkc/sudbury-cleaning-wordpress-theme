...
define('SUDBURY_THEME_VERSION', '1.0.0');
define('SUDBURY_THEME_DIR', get_template_directory());
define('SUDBURY_THEME_URI', get_template_directory_uri());

require SUDBURY_THEME_DIR . '/inc/theme-setup.php';
require SUDBURY_THEME_DIR . '/inc/enqueue.php';
require SUDBURY_THEME_DIR . '/inc/helpers.php';
require SUDBURY_THEME_DIR . '/inc/customizer.php';
